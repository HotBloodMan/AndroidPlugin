...
public class BinderHookHelper {
    ...
    public static void hookClipboardService() throws Exception{
        ...
        //下面这一段实际就是：ServiceManager.getService("clipboard");
        //只不过ServiceManger这个类是@hide的
        Class<?> serviceManager = Class.forName("android.os.ServiceManager");
        Method getService=serviceManager.getDeclaredMethod("getService",String.class);

        //ServiceManager里面管理的原始的Clipboard Binder对象，一般来说这是一个Binder代理对象
        IBinder rawBinder= (IBinder) getService.invoke(null,CLIPBOARD_SERVICE);
        //Hook掉这个Binder代理对象的queryLocalInterface方法 然后在queryLocalInterface
        ...
        //以后查询的时候 会优先查询缓存里面的Binder,这样就会使用被我们修改过的Binder
